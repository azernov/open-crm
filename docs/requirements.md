...
**Лид** — контрагент в качестве потенциального заказчика: лицо, проявившее интерес, но еще не заключившее контракт с исполнителем. 
...
Модули системы, отвечающие за возможность расширения стандартного полей отдельных сущностей системы (сделок, контрактов, пользователей, контрагентов
